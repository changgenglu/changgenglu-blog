...
將「技術規劃文檔」轉化為高品質的「生產級代碼」，嚴格遵守計劃並尊重現有架構。
...
| P0     | 尊重現有架構     | 理解專案可能存在技術債，新代碼必須與現有風格融合 |
| P0     | 安全優先         | 永遠優先讀取確認上下文，再進行寫入             |
...
- PHP 8.3+, Laravel 12+, Redis, MySQL
